...
alias ls='eza --long --header --git --icons -a'
...
fzf-git-branch() {
    ...
    git branch --color=always --all --sort=-committerdate |
        ...
        fzf --height 50% --ansi --no-multi --preview-window right:65% \
            --preview 'git log -n 50 --color=always --graph --date=short --pretty="format:%C(auto)%cd %h%d %s" $(sed "s/.* //" <<< {})' |
        sed "s/.* //"
}
...
alias gt='git tag --sort=-v:refname | fzf --preview "git show --color=always {}"'
alias gll='g lg'
...
alias kcontext=k8s_change_context


#fzf-tmux
#

alias fzf='fzf --preview "bat --color=always --style=numbers --line-range=:498 {}"'
